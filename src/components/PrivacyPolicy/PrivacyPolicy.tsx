        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-lg mb-8">
            <p className="text-gray-700 leading-relaxed">
              At Codelithlabs, we take your privacy seriously. This Privacy Policy explains how we
          ...
          <div className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p className="mt-4">
                To exercise these rights, please contact us at team.codelithlabs@gmail.com
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-3xl p-8 border border-blue-100">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <ul className="space-y-2">
                <li>
                  <strong>Email:</strong> team.codelithlabs@gmail.com
                </li>
                <li>
